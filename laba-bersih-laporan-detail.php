...
<?php  
    $totalDpPenjualan = 0;
      ...
      ");
    while ($rowProduct = mysqli_fetch_array($queryInvoice)) {
    $totalDpPenjualan += $rowProduct['invoice_piutang_dp'];
  ?>
<?php } ?>
              ...
              <div class="laporan-laba-bersih-detail">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>b. Total DP Piutang</td>
                        <td>Rp <?= number_format($totalDpPenjualan, 0, ',', '.'); ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>d. Total DP Servis</td>
                        <td>Rp <?= number_format($totalDp, 0, ',', '.'); ?></td>
                      </tr>
                      <tr>
                        <td>e. Total Servis - Total DP Servis (Sisa Bayar)</td>
                      ...
                      <tr>
                        ...
                        <td>
                            <?php  
                              $totalPendapatan = $totalPenjualan + $piutang + $totalDp + $totalSisaBayarServis + $lb_pendapatan_lain + $totalDpPenjualan;
                      ...
                      <tr>
                        <td>k. Total Pembelian ke Supplier</td>
                      ...
                      <tr>
                        ...
                        <td>
                            <?php  
                              $totalBiayaPengeluaran = $user_gaji_pokok + $user_bonus + $ds_biaya_jasa_teknisiKeseluruhan + $lb_pengeluaran_listrik + $lb_pengeluaran_tlpn_internet + $lb_pengeluaran_perlengkapan_toko + $lb_pengeluaran_biaya_penyusutan + $lb_pengeluaran_bensin + $lb_pengeluaran_tak_terduga + $lb_pengeluaran_lain + $hutang + $totalDpHutang + $totalPembelian;
