...
$columns = array( 
    ...
    array( 'db' => 'ds_antrian', 'dt'               => 2 ), 
    array( 'db' => 'customer_nama', 'dt'            => 3 ), 
    array( 'db' => 'ds_terima_date_time',  'dt'     => 4 ), 
    array( 
        'db'        => 'ds_status', 
        'dt'        => 5, 
...
echo json_encode( 
    SSP::simple( $_GET, $dbDetails, $table, $primaryKey, $columns, null, "ds_cabang = $cabang &&  ds_status != 1 && ds_status != 2 && ds_status != 3 && ds_status != 4 && ds_status != 6 && ds_status != 7 && ds_status != 9 " )
    // SSP::simple( $_GET, $dbDetails, $table, $primaryKey, $columns, null, "ds_cabang = $cabang && ds_status = 5 || ds_status = 8 || ds_status = 0 " )
